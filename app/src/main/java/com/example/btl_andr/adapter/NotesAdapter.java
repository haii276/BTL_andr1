package com.example.btl_andr.adapter;
...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NoteViewHolder>{
    ...
    public NotesAdapter(List<Note> notes, NoteListeners noteListeners) {
        this.notes = notes;
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.layoutNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                noteListeners.onNoteCliked(notes.get(position),position);
            }
        });
    }
    @Override
    ...
    static class NoteViewHolder extends  RecyclerView.ViewHolder {
        ...
        RoundedImageView imageNote;
         ...
         NoteViewHolder(@NonNull View itemView) {
            ...
            textDatetime = itemView.findViewById(R.id.textDatetTime);
